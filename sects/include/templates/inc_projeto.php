        ...
        <header>
            <div class="p-3">
                <h1 class="h3 m-0 font-weight-bold">
                    <a href="/materia/<?php echo $projeto['slug'];?>/" class="text-dark"><?php echo $projeto['titulo'];?></a></h1>
            </div>

            <?php if($projeto['foto'] != NULL):?>

            <figure>
                <a href="/materia/<?php echo $projeto['slug'];?>/">
                    <img src="/public/uploads/fotos/<?php echo $projeto['foto'];?>" 
